...
const menuItems = [
    ...
    { tab: 'videos', label: 'Videos Page', icon: 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z' },
    { tab: 'scholarship', label: 'Scholarship Page', icon: 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0112 20.055a11.952 11.952 0 01-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z' },
    { tab: 'student-uniform', label: 'Student Uniform Page', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
    { tab: 'building', label: 'Building Page', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    { tab: 'degree-certificate', label: 'Degree Certificate Page', icon: 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z' },
    { tab: 'graduation-gown', label: 'Graduation Uniform Page', icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
    { tab: 'subdecree', label: 'Sub-Decree Page', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
...
<template>
    <aside class="w-68 bg-[#0c101b] border-r border-[#1a2333] flex flex-col justify-between flex-shrink-0 z-20 overflow-hidden">
        <div class="flex flex-col flex-1 overflow-hidden">
            <!-- Brand Title -->
            <div class="p-5 border-b border-[#1a2333] flex items-center gap-3.5 bg-gradient-to-r from-blue-950/20 to-transparent shrink-0">
            ...
            <!-- Navigation Tabs -->
            <nav class="p-3.5 space-y-1.5 flex-1 overflow-y-auto custom-scrollbar">
                <Link 
        ...
        <!-- Profile Info & Logout -->
        <div class="p-4 border-t border-[#1a2333] bg-[#090c14] flex items-center justify-between shrink-0">
